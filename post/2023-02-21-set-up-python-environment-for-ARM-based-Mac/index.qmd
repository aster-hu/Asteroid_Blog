...
date: 2023-02-21
categories: [2023, tutorial, python, macos]
...
We can start by checking the existing python version. Open the Terminal app and enter code as below.
...
![Python Interpreter Path in VS Code Setting](vsc_setting.png)
