...
categories: [data, openxlsx, readxl, R, excel, 2022]
date: 2022-11-18
toc: true
---

[![Openxlsx](Page19.png)](https://ycphs.github.io/openxlsx/)
...
I still prefer `openxlsx` to other as I like its arguments and it fits the business world well. There's a successor package `openxlsx2` on the way - Let's wait and see if it resolves the issue.
